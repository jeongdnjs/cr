...
void RosCommunicator::publishEncoderInfo()
{
  std_msgs::msg::Int64MultiArray msg;

  msg.data.push_back(encoder_count_1A);
  msg.data.push_back(encoder_count_1B);
  msg.data.push_back(encoder_count_2A);
  msg.data.push_back(encoder_count_2B);

  encoder_info_publisher_->publish(msg);
}
    ...
    : Node("tutorial_ros2_motor"), count_(0)
{
  ...
  encoder_info_publisher_ = this->create_publisher<std_msgs::msg::Int64MultiArray>("EncoderInfo", 10);
}
